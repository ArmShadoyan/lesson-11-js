...
const app = {
	...
	areArtakAdamyanIsCook(answer,isPresent){
		if (answer === "yes" && isPresent === "yes" && app.restaurantDetails[7].isOpen === true)
		{console.log("Այո Արտակ Ադամյանը այսօր աշխատում է")}
		else if(answer === "yes" && isPresent !== "yes" && app.restaurantDetails[7].isOpen === true)
		{console.log("Ցավոք Արտակ Ադամյանը այսօր չի աշխատում")}
	},
